...
#
# This is the pre-port bash implementation of .claude/hooks/pre-tool-use-guard.sh,
# restored verbatim from git `main` (blob 959b45fa6591c35823f65fc7e6396795cce1f61a).
